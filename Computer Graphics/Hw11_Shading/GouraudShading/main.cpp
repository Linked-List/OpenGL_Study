...
void renderScene() {
	...
	for (int i = 0; i < indices.size(); i=i+3) {
		...
		glm::vec3 inVector = glm::normalize(glm::cross(v1, v2));
		glVertexAttrib3fv(inNormal, glm::value_ptr(inVector));
		glDrawElements(GL_TRIANGLES, 3, GL_UNSIGNED_INT, (void*)(i*sizeof(int)));
	}
...
void init() {
	...
	mat = glm::mat4(1.0);
	glUniformMatrix4fv(glGetUniformLocation(programID, "worldMat"), 1, GL_FALSE, glm::value_ptr(mat));
	glUniformMatrix4fv(glGetUniformLocation(programID, "projMat"), 1, GL_FALSE, glm::value_ptr(mat));
	glUniformMatrix4fv(glGetUniformLocation(programID, "viewMat"), 1, GL_FALSE, glm::value_ptr(mat));
