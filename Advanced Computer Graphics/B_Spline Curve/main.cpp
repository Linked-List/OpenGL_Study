...
int main(int argc, char* argv[]) {
	...
	glUniform1f(glGetUniformLocation(programID, "u0"), 0);
	glUniform1f(glGetUniformLocation(programID, "u1"), 1);
	glUniform1f(glGetUniformLocation(programID, "u2"), 2);
	glUniform1f(glGetUniformLocation(programID, "u3"), 3);
